    ...
    */
    ...
    function changeColor1() {
      ...
      d3.selectAll("#reg_8,#reg_9")
        ...
        .duration(1000)
        .style("fill", "#ffff00");
      d3.select("#text_reg_8")
        .text("65% \uf0aa")//arrow up \uf0ab arrow down
        .attr("class", 'fas fa-arrow-circle-up')
        .attr('font-family', 'FontAwesome')
        .attr('font-size', '20px')
        .style('fill', 'black');
      d3.selectAll("#reg_10,#reg_11,#reg_12")
        .transition()
        .duration(1000)
        .style("fill", "#d80000");//red
      d3.select("#text_reg_11")
        .text("22% \uf0aa")//arrow up \uf0ab arrow down
        .attr("class", 'fas fa-arrow-circle-up')
        .attr('font-family', 'FontAwesome')
        .attr('font-size', '20px')
        .style('fill', 'black');
    ...
    function changeColor3() {
      d3.selectAll("#reg_1,#reg_3,#reg_4,#reg_5,#reg_6,#reg_7")
        ...
        .duration(1000)
        .style("fill", "#d80000");
      d3.selectAll("#text_reg_4")
        .text("20%\uf0aa")//arrow up \uf0ab arrow down
        .attr("class", 'fas fa-arrow-circle-up')
        .attr('font-family', 'FontAwesome')
        .attr('font-size', '20px')
        .style('fill', 'black');
